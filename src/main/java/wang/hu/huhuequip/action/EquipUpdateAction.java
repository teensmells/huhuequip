/**
 * Project: huhuequip File Created at 2014年4月25日 $Id$ Copyright 2010 dianping.com. All rights reserved. This software is
...
/**
 * TODO Comment of EquipUpdateAction
 * 
 * @author zhuchong
 */
public class EquipUpdateAction extends ActionSupport {

    /**
     * 
     */
    private static final long serialVersionUID = -3783519184195741010L;
    ...
    public String execute() {
        ...
        EquipVO equipVO = equipService.loadEquipVO(id);
        if (equipVO == null) {
            code = 500;
            msg = "参数错误";
            return SUCCESS;
        ...
        packEquipVO(equipVO, specialtyVO);

        equipService.updateEquipVO(equipVO);
        code = 200;
        msg = "保存成功";
        return SUCCESS;
    }
     ...
     * @param equipVO
     */
    private void packEquipVO(EquipVO equipVO, SpecialtyVO specialtyVO) {
